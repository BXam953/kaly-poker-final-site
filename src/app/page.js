...
export default function Home(){
  ...
  return (
    <main className=" h-screen w-screen overflow-x-hidden">
      ...
      <video ref={videoRef} width={100} height="auto" className="absolute h-screen w-screen object-cover" poster="video.png" src="https://res.cloudinary.com/dc3igtkil/video/upload/v1692002744/video1_jcdqnm.mp4" onEnded={() => {setVideoEnd(true)}} playsInline></video>
      { !videoStarted && 
